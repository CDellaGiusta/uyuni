...
public class CoCoSecureBootAttestationRequestData extends CoCoAbstractTestAttestationRequestData {
    ...
    public static final String SECURE_BOOT_ENABLED_KEY = "mgr_secureboot_enabled";
    ...
    public Map<String, Optional<StateApplyResult<CmdResult>>> getResults() {
        ...
        out.put(SECURE_BOOT_ENABLED_KEY, Optional.ofNullable(securebootResult));
        return out;
    }
        ...
        getSecureBoot()
                ...
                .ifPresent(c -> {
                    if (!c.getStdout().isEmpty()) {
                        out.put(SECURE_BOOT_ENABLED_KEY, c.getStdout());
                    }
                    else {
                        out.put(SECURE_BOOT_ENABLED_KEY, c.getStderr());
                    }
                });
        return out;
    }
