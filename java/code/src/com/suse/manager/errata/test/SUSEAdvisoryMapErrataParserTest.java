...
import com.suse.manager.errata.advisorymap.test.ErrataAdvisoryMapManagerTest;
...
public class SUSEAdvisoryMapErrataParserTest extends BaseErrataTestCase {
    ...
    {SUSE-Manager-Tools-For-SL-Micro-6-5, SUSE-RU-2025:20291-1}  computed: [SUSE-RU-2025:0005-1]
    {SUSE-SLE-Module-Live-Patching-15-SP3-2025-1112, SUSE-SU-2025:1119-1}  computed: [SUSE-SU-2025:1112-1]
    ...
    */
    ...
    public void testCanBuildValidLinkAndId() throws ErrataParsingException, IOException {
        ...
        ErrataAdvisoryMapManagerTest.createTestAdvisoryMapDatabase();

        final SUSEAdvisoryMapErrataParser parser = new SUSEAdvisoryMapErrataParser();

        String errataAdv;
        errataAdv = "SUSE-SLE-Live-Patching-12-SP5-2025-1901";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-SU-2025:01901-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-su-202501901-1/"));

        errataAdv = "SUSE-SLE-Module-Basesystem-15-SP7-2025-1638";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-SU-2025:01638-2"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-su-202501638-2/"));


        errataAdv = "SUSE-Manager-Tools-For-SL-Micro-6-5";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-RU-2025:20291-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-ru-202520291-1/"));

        errataAdv = "SUSE-SLE-Module-Live-Patching-15-SP3-2025-1112";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-SU-2025:1119-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-su-20251119-1/"));


        errataAdv = "SUSE-SLE-Module-Basesystem-15-SP6-2025-1562";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-OU-2025:1562-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-ou-20251562-1/"));

        errataAdv = "SUSE-SLE-Module-Packagehub-Subpackages-15-SP6-2025-37";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-FU-2025:0037-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-fu-20250037-1/"));


        errataAdv = "SUSE-SLE-Manager-Tools-For-Micro-5-2025-1319";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-RU-2025:1319-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
                .equals("https://www.suse.com/support/update/announcement/2025/suse-ru-20251319-1/"));

        errataAdv = "SUSE-SLE-Module-Development-Tools-15-SP6-2025-990";
        assertTrue(parser.getAnnouncementId(errataAdv).equals("SUSE-RU-2025:0990-1"));
        assertTrue(parser.getAdvisoryUri(errataAdv).toString()
